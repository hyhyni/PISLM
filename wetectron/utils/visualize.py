...
VOC_CATEGORIES = ["__background__", "airplane", "airport", "baseballfield", "basketballcourt", "bridge",
    "chimney", "dam", "Expressway-Service-area", "Expressway-toll-station", "harbor", "golffield", "groundtrackfield", "overpass",
    "ship", "stadium", "storagetank", "tenniscourt", "trainstation", "vehicle", "windmill"]
# VOC_CATEGORIES = ["__background__", "airplane", "airport", "baseballfield", "basketballcourt", "bridge",
#     "chimney", "dam", "servicearea", "tollstation", "harbor", "golffield", "groundtrackfield", "overpass",
#     "ship", "stadium", "storagetank", "tenniscourt", "trainstation", "vehicle", "windmill"]
...
def overlay_boxes(image, predictions):
    ...
    for box, color in zip(boxes, colors):
        ...
        image = cv2.rectangle(
            ...
            image, tuple(top_left), tuple(bottom_right), (0, 255, 0), 4
        )
    return image
...
def overlay_class_names(image, predictions, CATEGORIES):
    ...
    for box, score, label in zip(boxes, scores, labels):
        ...
        # cv2.rectangle(image, (box[0], box[1] - 16), (box[0] + 130, box[1]), (0, 0, 255), -1)
        if label == 'airplane':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 128, box[1]), (0, 255, 0), -1)
        elif label == 'airport':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 108, box[1]), (0, 255, 0), -1)
        elif label == 'baseballfield':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 196, box[1]), (0, 255, 0), -1)
        elif label == 'basketballcourt':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 242, box[1]), (0, 255, 0), -1)
        elif label == 'bridge':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 100, box[1]), (0, 255, 0), -1)
        elif label == 'chimney':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 132, box[1]), (0, 255, 0), -1)
        elif label == 'dam':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 72, box[1]), (0, 255, 0), -1)
        elif label == 'Expressway-Service-area':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 412, box[1]), (0, 255, 0), -1)
        elif label == 'Expressway-toll-station':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 386, box[1]), (0, 255, 0), -1)
        elif label == 'harbor':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 108, box[1]), (0, 255, 0), -1)
        elif label == 'golffield':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 128, box[1]), (0, 255, 0), -1)
        elif label == 'groundtrackfield':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 256, box[1]), (0, 255, 0), -1)
        elif label == 'overpass':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 144, box[1]), (0, 255, 0), -1)
        elif label == 'ship':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 68, box[1]), (0, 255, 0), -1)
        elif label == 'stadium':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 128, box[1]), (0, 255, 0), -1)
        elif label == 'storagetank':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 188, box[1]), (0, 255, 0), -1)
        elif label == 'tenniscourt':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 180, box[1]), (0, 255, 0), -1)
        elif label == 'trainstation':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 182, box[1]), (0, 255, 0), -1)
        elif label == 'vehicle':
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 110, box[1]), (0, 255, 0), -1)
        else: #"windmill"
            cv2.rectangle(image, (box[0], box[1] - 30), (box[0] + 126, box[1]), (0, 255, 0), -1)
        cv2.putText(
            image, s, (x, y-4), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 0), 2
        )
    return image
