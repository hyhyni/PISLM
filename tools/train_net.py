...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="/media/user/data/pqs_psla/configs/voc/V_16_voc07.yaml",
        metavar="FILE",
...
def update_iters():
    if cfg.SOLVER.ITER_SIZE > 1:
        assert cfg.DB.METHOD != "attention", "ITER_SIZE not supported with Concrete DropBlock"
